  ...
  const AddNurse = async () => {
    try {
      const result = await contract.methods
        .addNurse(inputId, inputLogin, inputPassword, inputName, inputGender, inputRole, inputHospital)
  ...
  return (
    ...
    <Card title="Add a Nurse  :"
      ...
      <Form  labelCol={{ span: 3 }}
        ...
        <Form.Item label="Name" rules={[{ required: true, message: 'Please enter the name of the nurse' }]}>
        ...
        <Form.Item label="Ethereum address " rules={[{ required: true, message: 'Please enter the address of the nurse' }]}>
        ...
        <Form.Item label="Gender" rules={[{ required: true, message: 'Please enter the gender of the nurse' }]}>
          <Input placeholder="Gender" 
                ...
                onChange={(t) => 
				      {
						  setInputGender(t.target.value);
					    }} />
        </Form.Item>

        <Form.Item label="Username" rules={[{ required: true, message: 'Please enter the username of the nurse' }]}>
          ...
          onChange={(t) => 
      {
       setInputLogin(t.target.value);
        ...
        <Form.Item label="Password" rules={[{ required: true, message: 'Please enter the password of the nusre' }]}>
        ...
        <Form.Item label="Role" rules={[{ required: true, message: 'Please enter the role of the nusre' }]}>
          ...
          onChange={(t) => 
      {
       setInputRole(t.target.value);
        ...
        <Form.Item label="Hospital" rules={[{ required: true, message: 'Please enter the hospital of the nusre' }]}>
        ...
        wrapperCol={{
          ...
          <Button type="primary" htmlType="submit" onClick={AddNurse}>
            Add
          </Button>
        </Form.Item>
      </Form>
